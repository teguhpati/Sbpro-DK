...
def help1():
    ...
    helpMessage1 = "▶️" + key + "TEGUH-BOT\n" + \
                  ...
                  "▶️" + key + "Teguhbot\n" + \
                  "▶️" + key + "Harga\n" + \
                  "▶️" + key + "Adminadd @\Admindell @\n" + \
                  "▶️" + key + "Staffadd @\Staffdell @「ɴᴏᴍᴇʀ」\n" + \
                  "▶️" + key + "Bot:on\off\n" + \
                  "▶️" + key + "Refresh\n" + \
                  "▶️" + key + "Botrefeat @\n" + \
                  "▶️" + key + "Promo\n" + \
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ = "• ▶️ ɴᴀᴍᴀ ɢʀᴜᴘ: {}".format(str(ginfo.name))
                                ...
                                ret_ += "\n▶️ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(str(ginfo.name))
                                ret_ += "\n▶️ᴡᴀᴋᴛᴜ ɴɢɪʀɪᴍ: {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n•▶️ᴘᴇsᴀɴɴʏᴀ : {}".format(str(msg_dict[msg_id]["text"]))
                                ret_ += "\n ▶️TEGUH-BOT"
                                ret_ += "\nCreator:  https://line.me/ti/p/Exv7vmiRm7" 
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Pagi","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "TEGUH-KILLER"
 "ASSALAMUALAIKUM\n"
"  ╭━TEGUH-BOT\n"
"  ╰╮┏━┳┳┓┏┳┳┓┏┳┳┳┓\n"
"  ┏┻╋━┻┻┫┣┻┻┫┣┻┻┻┫\n"
